...
<head>
    ...
    <title>Trả lời câu hỏi từ Pizza Shop</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="answer-box">
                <h3>Câu trả lời từ Pizza Shop:</h3>
                <p>{{ $faq->answer }}</p>
            </div>

            <p>Nếu bạn có thêm câu hỏi, vui lòng gửi qua <a href="{{ url('/contact') }}">form liên hệ</a> hoặc gọi
                hotline của chúng tôi.</p>
